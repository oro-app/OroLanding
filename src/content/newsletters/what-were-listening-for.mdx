...
![Oro](https://buildingoro.ca/static/oro-logo.png)

*Oro Insiders is published by Oro Digital Inc. Written from Toronto. If you're getting this, you signed up for the Oro app waitlist. Reply to this email and we'll read it. To stop receiving Oro Insiders, [unsubscribe]({{UNSUBSCRIBE_URL}}). To get on the waitlist, [buildingoro.ca](https://buildingoro.ca).*
