...
export const ROUTE_SEO = {
  ...
  'app-terms': {
    path: '/app/terms',
    title: 'Oro App - Terms of Service',
  ...
  privacy: {
    path: '/privacy',
    title: 'Oro - Texting Privacy Policy',
