...
const QUOTES = [
  { quote: 'i’ve tried other style apps. oro’s the only one that actually gets my taste: my colours, what fits my body, what i keep reaching for.', name: 'alex',   where: 'nyc',         avatar: ORO_PHOTOS.hero2 },
  ...
  { quote: 'changing in and out of outfits is exhausting. now i try everything on oro first and only put on what i’m actually wearing.',            name: 'morgan', where: 'toronto',     avatar: ORO_PHOTOS.hero4 },
]
